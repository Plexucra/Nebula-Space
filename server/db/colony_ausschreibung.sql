...
CREATE TABLE `ausschreibung` (
  ...
  `grundstueckId` bigint(20) unsigned NOT NULL,
  `kosten` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `ausschreibung`
--

LOCK TABLES `ausschreibung` WRITE;
/*!40000 ALTER TABLE `ausschreibung` DISABLE KEYS */;
/*!40000 ALTER TABLE `ausschreibung` ENABLE KEYS */;
UNLOCK TABLES;
